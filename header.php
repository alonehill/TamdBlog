...
<head>
    ...
    <!-- 思源宋体 -->
    <!-- 本地方法 文件大加载缓慢
    <link href="<?php $this->options->themeUrl('static/font/Noto+Serif+SC@700.css'); ?>" rel="stylesheet">
    <link href="<?php $this->options->themeUrl('static/font/Noto+Serif+SC@400.css'); ?>" rel="stylesheet">
    ...
    <?php $this->need('widget/TopSlide.php'); ?>
    <!-- 通过自有函数输出HTML头部信息 -->
    <?php $this->header(); ?>
</head>
<body>
