...
<?php if ($this->options->sliderStatus == 'on') { ?>
    ...
    <div id="topSlide" class="carousel slide carousel-fade containerxx" data-bs-ride="carousel">
        ...
        <?php while($sliderCategory->next()): ?>
            <div class="carousel-item topslideimg <?php echo $index == 0 ? 'active' : ''; ?>" style="background-image: url(<?php echo get_post_img($sliderCategory); ?>?x-oss-process=image/format,webp);">
