...
<?php if ($this->options->sliderStatus == 'on') { ?>
    ...
    <div id="topSlide" class="carousel slide carousel-fade containerxx" data-bs-ride="carousel">
        ...
        <?php while($sliderCategory->next()): ?>
            <div class="carousel-item topslideimg <?php echo $index == 0 ? 'active' : ''; ?>" style="background-image: url(<?php echo get_post_img($sliderCategory); ?>?x-oss-process=image/format,webp);transform: translateZ(0);">
                <div class="topslidecontent p-3">
            ...
            <div class="carousel-item topslideimg active" style="background-image: url('<?php $this->options->themeUrl("static/img/404-bg.jpg");?>');">
                <div class="topslidecontent">
                    <div class="text-center">
                        ...
                        <p class="mt-md-4 carousel-text-shadow">未在幻灯片分类下设置文章，先去写一篇带有图片或者图片附件的文章吧</p >
                    </div>
                </div>
            </div>
                ...
                <section class="article-list">
                    ...
                    <a href="<?php $this->permalink() ?>" class="index-post-card">
                        ...
                        <div class="index-post-front-img-box">
                            <img src="<?php echo get_post_img($this); ?>" onerror="this.src='<?php echo $thumb; ?>'" alt="<?php $this->title() ?>" loading="lazy">
                        </div>
