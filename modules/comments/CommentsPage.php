        ...
        <div class="comment-main">
            <div class="comment-header">
                <div class="comment-meta">
                    ...
                    <?php endif; ?>
                    <?php show_comment_ip_location($comments); ?>
...
@media (max-width: 768px) {
    ...
    /* 回复框占满整行，排在下面 */
    .comment-item > .comment-body > .respond {
        width: 100%;
        flex-basis: 100%;
        margin-top: 16px;
        padding: 16px;
    ...
    /* 输入框单列 */
    .comment-body .comment-inputs-grid {
        grid-template-columns: 1fr !important;
    }
    
    /* 提交按钮铺满 */
    .comment-body .submit-btn {
        width: 100%;
    }
}
  /* ========== 表情面板样式 ========== */
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    for (const [codepoint, [shortcode, filename]] of Object.entries(emojiMap)) {
        ...
        img.src = themeUrl + '/static/emojis/' + filename;
        img.alt = shortcode;
        img.width = 32;
        img.height = 32;
        img.loading = 'lazy';
