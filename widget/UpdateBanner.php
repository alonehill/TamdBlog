...
<div class="admin-update-overlay" id="adminUpdateOverlay" style="display: flex;">
    <div class="update-modal m-4">
        ...
        <div class="update-modal-body">
            <p>主理人，欢迎回来。站点已成功升级并完成多端数据同步。</p >
            <ul>
                <li><strong>跨端记忆：</strong> 状态直连数据库，全平台仅展现一次，告别设备割裂。</li>
                <li><strong>模块解耦：</strong> 剔除第三方插件植入感，采用原生沉浸式全屏弹窗。</li>
                <li><strong>无缝流式：</strong> 底部接入「微圆角方块」AJAX 接力无缝分页器。</li>
            </ul>
        </div>
...
<script>
    ...
    document.getElementById('closeUpdateOverlayBtn').addEventListener('click', function() {
        ...
        fetch('/?action=dismiss_theme_update', { method: 'POST', body: formData });
...
<div class="admin-update-notifier ms-4" id="adminUpdateNotifier" style="display: none;">
    ...
    <div class="notifier-actions">
        <a href="/admin/options-theme.php" class="btn-check-update">一键更新</a >
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    fetch('/?action=check_theme_update')
